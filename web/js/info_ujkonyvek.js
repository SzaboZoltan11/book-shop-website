        ...
        fetch(`books.php?startYear=${startYear}&endYear=${endYear}`)
            ...
            .then(v => {
                ...
                for (const book of v.books) {
                    ...
                    booksHtml += `
                        <div class="card">
                        ${isLoggedIn === 'true' ? `<span class="wishlist-icon" data-id="${book.id}" data-cover="${book.cover}" data-title="${book.title}" data-price="${book.price}">&#9825;</span>` : ""}
                ...
                document.getElementById('ujkonyv-details').innerHTML = booksHtml;
            ...
            .catch(e => {
                console.error(e);
                document.getElementById('ujkonyv-details').innerHTML = "Hiba történt a könyvek betöltésekor.";
            });
    }
