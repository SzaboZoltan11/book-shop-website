document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadBooks(categoryIds) {
        ...
        fetch('books.php?' + queryString)
            ...
            .then(data => {
                if (data.error) {
                    document.getElementById('ismeretterjeszto-details').innerHTML = data.error;
                    return;
                }
                ...
                document.getElementById('ismeretterjeszto-details').innerHTML = booksHtml;
            ...
            .catch(error => {
                console.error(error);
                document.getElementById('ismeretterjeszto-details').innerHTML = "Hiba történt a könyvek betöltésekor.";
            });
    }

    loadBooks([2,6,7,8,10]);
